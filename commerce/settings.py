...
# Configuración del tipo de campo predeterminado para las claves primarias
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / 'auctions' / 'static',  # Directory where your app-specific static files are stored
]
